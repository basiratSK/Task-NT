...
<body>
	...
	<br>
		...
		<br>
					...
					<form method="post"> 
					<textarea name="post_content" class="form-control" srows="7" cols="64" style="" placeholder=".........Write Someting........" required></textarea>
					<br>
					...
					<hr>
						...
						?>
					<a style="text-decoration:none; float:right;" href="deletepost.php<?php echo '?id='.$id; ?>"><button class="btn btn-primary">Delete<font color="red">x</button></font></a>
